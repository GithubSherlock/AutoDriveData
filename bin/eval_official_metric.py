...
用法(在 maptr_official env 下,官方代码只读引用、不修改):
  PYTHONPATH=$PWD /root/autodl-tmp/envs/maptr_official/bin/python bin/eval_official_metric.py \
...
from autodrivedata.mapvec import BEV_RANGE
from autodrivedata.mapvec_schema import load_frame
