...
from maptr_impl.gkt import BEV_DEFAULT as BEV
from maptr_impl.temporal import TemporalFusion, ego_rotations, warp_bev
...
class TestEgoRotations:
    def test_matches_gkt_cam_world_pose_convention(self):
        ...
        from maptr_impl.gkt import cam_world_pose
...
class TestCheckpoint口径:
    ...
    def test_single_frame_weights_are_a_legal_warm_start(self, tmp_path):
        from maptr_impl.model import load_map_weights
